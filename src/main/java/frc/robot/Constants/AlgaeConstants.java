...
public class AlgaeConstants {
    ...
    public static final double PIVOT_UP_DEGREES = 20;
    public static final double PIVOT_DOWN_DEGREES = -30;
    public static final double PIVOT_GROUND_DEGREES = -35;

    public static final double PICKUP_INTAKE_SPEED = -0.5;
    public static final double PICKUP_OUTTAKE_SPEED = 1;
}
